...
**Endpoint AI агент → Бэкенд:** `POST /api/auth/init`
...
**AI агент должен передать в бэкенд:**
```json
{
  "tg_id": 123456789,
  "username": "test_user"
...
**Примечание:** Вызывается автоматически при первом взаимодействии пользователя с ботом (команда `/start`).
